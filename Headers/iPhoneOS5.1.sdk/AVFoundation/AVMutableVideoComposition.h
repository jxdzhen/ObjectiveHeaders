...
@class AVVideoCompositionCoreAnimationTool, AVMutableVideoCompositionInternal, NSArray;
...
+(id)videoComposition;
+(id)videoCompositionForAsset:(id)asset;
+(id)videoCompositionForAsset:(id)asset videoGravity:(id)gravity;
