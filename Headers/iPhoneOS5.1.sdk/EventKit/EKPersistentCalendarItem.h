...
@class NSString, NSURL, NSData, NSTimeZone, NSSet, EKPersistentLocation, EKPersistentCalendar, EKPersistentOrganizer, EKPersistentAttendee, NSDate;
...
// declared property getter: -(int)externalTrackingStatus;
...
// declared property setter: -(void)setExternalTrackingStatus:(int)status;
