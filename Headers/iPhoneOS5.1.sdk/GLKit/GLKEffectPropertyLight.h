...
+(id)effectPropertyWithAttrib:(int)attrib;
+(void)setStaticMasksWithVshRoot:(id)vshRoot fshRoot:(id)root;
-(id)initWithTransform:(id)transform lightingType:(int)type firstLight:(unsigned char)light useConstantColor:(unsigned char)color;
