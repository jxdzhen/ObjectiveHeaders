...
@class UIButton, NSMutableDictionary, NSMutableArray, UITextField, UIImage, NSString, NSTimer, UIView, MFComposeRecipient, MFComposeRecipientAtom, NSArray, NSCountedSet;
...
-(void)_addRecord:(void*)record property:(int)property identifier:(int)identifier;
