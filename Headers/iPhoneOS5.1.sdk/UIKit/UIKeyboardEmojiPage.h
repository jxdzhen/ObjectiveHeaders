...
@class NSString, UIKeyboardEmojiView, NSArray, UITouch;
...
@property(retain) NSString* optionalText;	// @synthesize=_optionalText
...
// declared property getter: -(id)optionalText;
...
// declared property setter: -(void)setOptionalText:(id)text;
