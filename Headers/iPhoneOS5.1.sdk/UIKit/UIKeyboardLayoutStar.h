...
@class UIDelayedAction, NSMutableDictionary, NSMutableSet, UISwipeGestureRecognizer, NSTimer, CADisplayLink, UIKBKeyplaneView, UIKBTree, NSString, UIKBBackgroundView;
...
-(id)mergableKeyplaneSwitchKeyForRendering:(int)rendering;
...
-(id)shapesForControlKeyShapes:(id)controlKeyShapes split:(BOOL)split;
-(id)shapesForControlKeyShapes:(id)controlKeyShapes split:(BOOL)split alternateCJMerge:(BOOL)merge;
