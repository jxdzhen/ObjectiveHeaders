...
@property(assign, nonatomic) int shakeState;	// @synthesize=_shakeState
...
-(void)dealloc;
-(id)description;
// declared property setter: -(void)setShakeState:(int)state;
// declared property getter: -(int)shakeState;
-(int)subtype;
-(int)type;
@end
