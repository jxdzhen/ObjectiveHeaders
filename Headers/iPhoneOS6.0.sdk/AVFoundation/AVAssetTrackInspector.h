...
@property(readonly, assign, nonatomic) NSArray* mediaCharacteristics;
...
-(void)dealloc;
// declared property getter: -(CGSize)dimensions;
...
// declared property getter: -(id)mediaCharacteristics;
