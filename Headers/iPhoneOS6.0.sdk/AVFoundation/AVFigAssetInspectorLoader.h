...
@class AVAssetInspector, NSDictionary, NSMutableArray, NSObject, AVAssetCache, NSURL;
...
-(OpaqueFigAsset*)_figAsset;
-(OpaqueFigFormatReader*)_formatReader;
-(id)_initWithDownloadToken:(unsigned long long)downloadToken;
-(id)_initWithFigAsset:(OpaqueFigAsset*)figAsset options:(id)options;
-(BOOL)_isStreaming;
