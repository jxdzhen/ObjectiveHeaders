...
@class ABContactsFilter, ABPersonViewControllerHelper, ABPersonTableViewDataSource;
...
@property(retain, nonatomic) ABContactsFilter* parentContactsFilter;	// @synthesize=_parentGroup
...
// declared property getter: -(id)parentContactsFilter;
...
// declared property setter: -(void)setParentContactsFilter:(id)filter;
