...
@class UIActionSheet, UIResponder, UIWindow, UIPopoverController, UIView, UIBarButtonItem;
@protocol ABPopoverRepresentDelegate;

@interface ABPopoverManager : XXUnknownSuperclass <UIPopoverControllerDelegate, UIActionSheetDelegate> {
@private
