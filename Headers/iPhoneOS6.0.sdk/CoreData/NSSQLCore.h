...
@class NSURL, NSOperationQueue, NSString, NSSaveChangesRequest, NSMutableArray, NSSQLAdapter, NSSet, NSSQLModel, NSManagedObjectContext, NSSQLConnection, NSMutableSet, NSMutableDictionary, NSSQLRow, NSSQLEntity, NSSQLRowCache;
...
-(void)_populateOrderKeysInOrderedSet:(id)orderedSet usingSourceObjectID:(id)anId inverseRelationship:(id)relationship newIndexes:(unsigned**)indexes reorderedIndexes:(char**)indexes5;
