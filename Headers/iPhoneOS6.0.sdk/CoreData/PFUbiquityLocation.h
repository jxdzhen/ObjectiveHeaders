...
@interface PFUbiquityLocation : XXUnknownSuperclass <NSCopying> {
@private
...
+(id)createPeerBaselineFileLocationForLocalPeerID:(id)localPeerID andBaselineFileLocation:(id)location;
...
+(void)setLocationSentinel:(id)sentinel;
-(id)init;
...
-(BOOL)fileExistsAtLocationWithLocalPeerID:(id)localPeerID;
