...
@class NSManagedObject, NSString, NSArray, NSDate, PFUbiquityImportContext, NSNumber, PFUbiquityKnowledgeVector, NSDictionary;
...
+(id)createTransactionLogForTransactionEntry:(id)transactionEntry withImportContext:(id)importContext error:(id*)error;
