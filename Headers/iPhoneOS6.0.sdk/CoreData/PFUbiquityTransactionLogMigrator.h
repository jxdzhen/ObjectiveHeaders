...
@class NSString, NSManagedObjectModel, NSSet, NSMappingModel, NSDictionary;
...
-(id)initWithSourceModel:(id)sourceModel destinationModel:(id)model mappingModel:(id)model3 localPeerID:(id)anId;
