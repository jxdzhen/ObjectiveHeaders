...
@class NSArray, NSURL, EKCalendar, NSDate, NSTimeZone, NSString;
...
@property(readonly, assign, nonatomic) NSString* calendarItemExternalIdentifier;
@property(readonly, assign, nonatomic) NSString* calendarItemIdentifier;
...
// declared property getter: -(id)calendarItemExternalIdentifier;
// declared property getter: -(id)calendarItemIdentifier;
...
-(void)setDefaultAlarmRemoved:(BOOL)removed;
...
-(void)setSharedItemModifiedByEmailAddress:(id)address;
