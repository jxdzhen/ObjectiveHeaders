...
-(void)_fastpathSetProperty:(id)property forKey:(id)key isRelation:(BOOL)relation;
...
-(void)_takeValuesForDefaultProperties:(id)defaultProperties;
-(void)changed;
...
-(void)takeValues:(id)values forProperties:(id)properties;
