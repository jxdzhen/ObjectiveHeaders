...
@class NSArray, EKPersistentCalendarItem, NSDate, EKRecurrenceEnd, NSString;
...
@property(readonly, assign, nonatomic) NSDate* cachedEndDate;
...
-(id)_helper;
// declared property getter: -(id)cachedEndDate;
