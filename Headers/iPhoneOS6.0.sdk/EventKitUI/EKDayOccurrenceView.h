...
@class EKEvent, UIColor, NSString, EKDayOccurrenceContentView, UIImageView, EKOccurrenceViewOverlay, UIView;
...
@property(assign, nonatomic, getter=isFacebook) BOOL facebook;
@property(copy, nonatomic) NSString* location;
@property(assign, nonatomic) BOOL needsReply;
...
+(id)_cachedImageForBackgroundColor:(id)backgroundColor foregroundColor:(id)color dimmed:(BOOL)dimmed;
+(void)_clearViewCache;
+(id)_imageForBackgroundColor:(id)backgroundColor foregroundColor:(id)color dimmed:(BOOL)dimmed;
+(id)_viewCache;
