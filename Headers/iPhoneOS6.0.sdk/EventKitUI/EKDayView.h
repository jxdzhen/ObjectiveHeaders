...
@class EKDayViewContent, UIImageView, EKDayAllDayView, UIView, EKPadDayAllDayView, NSDateComponents, NSCalendar, UIScrollView, NSArray, UIScrollAnimation, NSDate, EKDayTimeView, EKEvent;
...
-(void)_scrollToSecond:(int)second animated:(BOOL)animated whenFinished:(id)finished;
...
-(void)scrollToDate:(id)date animated:(BOOL)animated whenFinished:(id)finished;
