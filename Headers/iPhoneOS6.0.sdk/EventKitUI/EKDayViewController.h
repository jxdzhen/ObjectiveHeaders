...
@class UIView, EKDayView, NSDateComponents, NSCalendar, UIScrollView, CalendarOccurrencesCollection, EKDayBannerView, EKEventGestureController;
...
@property(assign, nonatomic) BOOL shouldAutoscrollOnNextActivation;	// @synthesize=_shouldAutoscrollOnNextActivation
...
-(void)scrollToSecond:(unsigned)second;
...
// declared property setter: -(void)setShouldAutoscrollOnNextActivation:(BOOL)autoscrollOnNextActivation;
// declared property setter: -(void)setShowsBanner:(BOOL)banner;
-(void)setTimeZone:(id)zone;
// declared property getter: -(BOOL)shouldAutoscrollOnNextActivation;
