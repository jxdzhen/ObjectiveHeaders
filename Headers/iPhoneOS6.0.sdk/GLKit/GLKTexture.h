...
@property(readonly, assign) BOOL hasPremultipliedAlpha;	// @synthesize=_hasPremultipliedAlpha
...
-(void)dealloc;
-(BOOL)decodeCGImage:(CGImageRef)image;
-(BOOL)decodeCGImageDataProvider:(CGImageRef)provider;
-(BOOL)decodeCGImageImageProvider:(CGImageRef)provider CGImageProvider:(CGImageProviderRef)provider2;
...
// declared property getter: -(BOOL)hasPremultipliedAlpha;
...
-(BOOL)premultiplyWithAlpha:(void*)alpha source:(void*)source withWidth:(unsigned)width withHeight:(unsigned)height withRowBytes:(unsigned)rowBytes error:(id*)error;
// declared property getter: -(BOOL)reOrient;
-(BOOL)reorientToGL:(void*)gl source:(void*)source withWidth:(unsigned)width withHeight:(unsigned)height withRowBytes:(unsigned)rowBytes error:(id*)error;
