...
@private
	...
	unsigned _maxGameStateSizeTurnBased;
...
@property(retain, nonatomic) GKPlayerInternal* localPlayer;	// @synthesize=_localPlayer
@property(assign, nonatomic) BOOL loginDisabled;	// @synthesize=_loginDisabled
@property(assign, nonatomic) unsigned maxGameStateSizeTurnBased;	// @synthesize=_maxGameStateSizeTurnBased
