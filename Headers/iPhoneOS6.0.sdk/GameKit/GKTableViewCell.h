...
@class GKUITheme, UIView, UIButton, UIImageView;
...
@property(retain, nonatomic) UIButton* disclosureButton;	// @synthesize=_disclosureButton
...
-(void)dealloc;
-(id)description;
// declared property getter: -(id)disclosureButton;
...
// declared property setter: -(void)setDisclosureButton:(id)button;
