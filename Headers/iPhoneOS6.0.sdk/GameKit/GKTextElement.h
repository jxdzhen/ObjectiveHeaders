...
@property(retain, nonatomic) NSAttributedString* highlightedAttributedText;	// @synthesize=_highlightedAttributedText
...
@property(assign, nonatomic) unsigned maxLines;	// @synthesize=_maxLines
...
-(CGSize)drawInRect:(CGRect)rect highlighted:(BOOL)highlighted actualFontSize:(float*)size;
// declared property getter: -(id)font;
// declared property getter: -(BOOL)hidden;
// declared property getter: -(id)highlightedAttributedText;
...
// declared property getter: -(unsigned)maxLines;
...
// declared property setter: -(void)setHighlightedAttributedText:(id)text;
...
// declared property setter: -(void)setMaxLines:(unsigned)lines;
...
-(CGSize)sizeForWidth:(float)width maxLineCount:(unsigned)count;
-(CGSize)sizeForWidth:(float)width maxLineCount:(unsigned)count actualFontSize:(float*)size;
