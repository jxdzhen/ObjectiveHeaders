...
@property(assign, nonatomic) BOOL hideNavigationBar;	// @synthesize=_hideNavigationBar
-(void)backgroundViewDidUpdate;
// declared property getter: -(BOOL)hideNavigationBar;
// declared property setter: -(void)setHideNavigationBar:(BOOL)bar;
