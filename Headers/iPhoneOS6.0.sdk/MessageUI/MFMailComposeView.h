...
@class UIPickerView, UIResponder, NSInvocation, MFComposeTextContentView, NSArray, UITableView, MFFromAddressViewController, MFComposeBodyField, MFComposeSubjectView, MFComposeScrollView, MFComposeImageSizeView, MFMailComposeRecipientView, MFComposeFromView, MFComposeMultiView, MFMailComposeContactsSearchController, UIView, NSString;
@protocol MFMailPopoverManagerDelegate, MFMailComposeViewDelegate, MFMailComposeRecipientViewDelegate;

@interface MFMailComposeView : XXUnknownSuperclass <UITextContentViewDelegate, UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, MFMailComposeContactsSearchControllerDelegate, MFComposeBodyFieldDelegate, MFDragContext> {
@private
...
@property(readonly, assign, nonatomic) MFComposeTextContentView* bodyTextView;	// @synthesize=_textView
...
-(id)initWithFrame:(CGRect)frame options:(unsigned)options;
...
-(void)_layoutFromFieldWithChangingView:(id)changingView toSize:(CGSize)size fieldFrame:(CGRect)frame;
...
-(void)dragBeganInWindow:(id)window;
-(void)dragEnded;
-(id)dragScrollView;
-(id)dragWindow;
