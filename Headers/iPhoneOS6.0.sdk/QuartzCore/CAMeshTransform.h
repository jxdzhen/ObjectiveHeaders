...
@property(readonly, assign) NSString* depthNormalization;
@property(readonly, assign) unsigned long faceCount;
@property(readonly, assign) int subdivisionSteps;
@property(readonly, assign) unsigned long vertexCount;
