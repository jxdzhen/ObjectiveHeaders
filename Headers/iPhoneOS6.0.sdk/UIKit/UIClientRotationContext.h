...
@property(assign, nonatomic) BOOL skipClientRotationCallbacks;	// @synthesize=_skipClientRotationCallbacks
...
// declared property setter: -(void)setSkipClientRotationCallbacks:(BOOL)callbacks;
-(void)setupRotationOrderingKeyboardInAfterRotation:(BOOL)afterRotation;
// declared property getter: -(BOOL)skipClientRotationCallbacks;
