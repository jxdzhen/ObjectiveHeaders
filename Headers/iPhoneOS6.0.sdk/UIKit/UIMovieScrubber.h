...
@class UIImageView, UILabel, UIImage, UIMovieScrubberTrackView, UIMovieScrubberEditingView;
...
@property(assign, nonatomic) double zoomDelay;	// @synthesize=_zoomDelay
...
// declared property setter: -(void)setZoomDelay:(double)delay;
...
// declared property getter: -(double)zoomDelay;
@end
