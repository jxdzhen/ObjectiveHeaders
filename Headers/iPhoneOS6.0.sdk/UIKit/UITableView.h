...
@class NSArray, NSTimer, UIRefreshControl, UIGestureRecognizer, UILongPressGestureRecognizer, UIColor, NSMutableDictionary, UISwipeGestureRecognizer, NSMutableArray, UITableViewCell, NSIndexPath, UITouch;
...
@property(retain, nonatomic) UITouch* currentTouch;	// @synthesize=_currentTouch
...
// declared property getter: -(BOOL)_adjustsRowHeightsForSectionLocation;
...
-(void)_configureCellForDisplay:(id)display forIndexPath:(id)indexPath;
-(UIEdgeInsets)_contentInset;
-(CGPoint)_contentOffsetForScrollingToRowAtIndexPath:(id)indexPath atScrollPosition:(int)scrollPosition;
-(CGSize)_contentSize;
...
// declared property getter: -(id)_refreshControl;
-(void)_reloadDataIfNeeded;
-(void)_reloadSectionHeaderFooters:(id)footers withRowAnimation:(int)rowAnimation;
...
-(id)_reorderingSupport;
-(void)_resumeReloads;
-(void)_reuseHeaderFooterView:(id)view isHeader:(BOOL)header forSection:(int)section;
-(void)_reuseTableViewCell:(id)cell withIndexPath:(id)indexPath;
...
-(id)_sectionFooterViewWithFrame:(CGRect)frame forSection:(int)section floating:(BOOL)floating reuseViewIfPossible:(BOOL)possible;
-(int)_sectionForFooterView:(id)footerView;
-(int)_sectionForHeaderView:(id)headerView;
-(id)_sectionHeaderView:(BOOL)view withFrame:(CGRect)frame forSection:(int)section floating:(BOOL)floating reuseViewIfPossible:(BOOL)possible;
-(id)_sectionHeaderViewWithFrame:(CGRect)frame forSection:(int)section floating:(BOOL)floating reuseViewIfPossible:(BOOL)possible;
...
// declared property setter: -(void)_setAdjustsRowHeightsForSectionLocation:(BOOL)sectionLocation;
-(void)_setBackgroundColor:(id)color animated:(BOOL)animated;
-(void)_setBottomPadding:(float)padding;
...
// declared property setter: -(void)_setRefreshControl:(id)control;
-(void)_setRowCount:(unsigned)count;
...
-(void)_setTopPadding:(float)padding;
...
-(void)_setupSectionView:(id)view isHeader:(BOOL)header forSection:(int)section;
...
-(void)_updateSections:(id)sections updateAction:(int)action withRowAnimation:(int)rowAnimation headerFooterOnly:(BOOL)only;
...
// declared property getter: -(id)currentTouch;
...
-(id)dequeueReusableCellWithIdentifier:(id)identifier forIndexPath:(id)indexPath;
...
-(id)footerViewForSection:(int)section;
...
-(BOOL)highlightRowAtIndexPath:(id)indexPath animated:(BOOL)animated scrollPosition:(int)position;
...
-(void)registerClass:(Class)aClass forCellReuseIdentifier:(id)cellReuseIdentifier;
...
// declared property getter: -(id)sectionIndexColor;
// declared property getter: -(int)sectionIndexMinimumDisplayRowCount;
// declared property getter: -(id)sectionIndexTrackingBackgroundColor;
...
// declared property setter: -(void)setCurrentTouch:(id)touch;
...
// declared property setter: -(void)setSectionIndexColor:(id)color;
// declared property setter: -(void)setSectionIndexMinimumDisplayRowCount:(int)count;
// declared property setter: -(void)setSectionIndexTrackingBackgroundColor:(id)color;
