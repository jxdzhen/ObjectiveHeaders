...
@class ABPersonNameDisplayView, ABPersonImageView, ABPersonNameEditingViewContainer, UIFont, UIView, ABNamePropertyGroup, UIImageView, NSString, ABMultiCellContentView;
...
@property(readonly, assign, nonatomic) UIView* editingViewContainer;	// @synthesize=_editingViewContainer
...
// declared property getter: -(id)editingViewContainer;
