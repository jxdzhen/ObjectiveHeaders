...
@class PFUbiquityKnowledgeVector, PFUbiquityPeer, NSDictionary, PFUbiquityStoreSaveSnapshot, PFUbiquityTransactionLog, NSString, _PFUbiquityStack, PFUbiquityStoreMetadata;
