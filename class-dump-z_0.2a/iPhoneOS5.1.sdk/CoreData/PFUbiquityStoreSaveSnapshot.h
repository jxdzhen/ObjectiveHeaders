...
@class NSMutableDictionary, NSDictionary, NSArray, NSString, NSNumber, NSMutableArray;
...
-(id)initWithPersistentStoreOptions:(id)persistentStoreOptions andLocalPeerID:(id)anId;
...
-(void)setEntityNames:(id)names globalObjectIDs:(id)ids primaryKeys:(id)keys forStoreWithName:(id)name;
