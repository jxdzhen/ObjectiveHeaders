...
@class NSURLRequest, NSURL, NSOperationQueue, NSURLConnection, NSDictionary;

__attribute__((visibility("hidden")))
@interface NSURLConnectionInternal : XXUnknownSuperclass <NSURLConnectionRequired, NSURLAuthenticationChallengeSender> {
@private
