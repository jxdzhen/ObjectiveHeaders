...
@interface GKItemIndexedTableSection : XXUnknownSuperclass <GKTableSection> {
@private
	SEL _action;
...
@property(assign, nonatomic) BOOL showMoreVisible;	// @synthesize=_showMoreVisible
...
// declared property setter: -(void)setShowMoreVisible:(BOOL)visible;
