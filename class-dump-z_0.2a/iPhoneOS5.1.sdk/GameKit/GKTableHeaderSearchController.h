...
@class GKTableViewControllerV2, UISearchDisplayController, NSArray, UISearchBar, GKTableView;
...
@property(retain, nonatomic) NSArray* searchTableSections;	// @synthesize=_searchTableSections
...
@interface GKTableHeaderSearchController (Conveniences)
