...
@class NSString, NSTimer, MPAudioVideoRoutingPopoverController, MPInlineAudioOverlay, UIViewController, UITapGestureRecognizer, UIView, UIWindow, UIPinchGestureRecognizer, MPInlineVideoOverlay;
