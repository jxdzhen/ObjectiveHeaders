...
@class MPTVOutWindow, MPVideoBackgroundView, UIImage, UIAlertView, UIColor, MPClosedCaptionDisplay, UIActivityIndicatorView, MPVideoView, UIView, MPImageCache, MPImageCacheRequest, MPSwipableView;
...
-(void)crossedClosedCaptionTimeMarker:(id)marker;
-(void)dealloc;
