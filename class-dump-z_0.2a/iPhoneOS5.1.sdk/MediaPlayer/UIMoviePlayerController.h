...
@class MPVideoViewController, MPAVItem, UIMovieSnapshotView, NSString, NSDate, NSArray, UIImage, UIViewController, UINavigationController, MPTransitionController, MPVideoView, MPSystemNowPlayingController, UIView, MPAVController, MPMovieAccessLog, MPMovieErrorLog;
